...
function MainSliderButton({ buttonContent, linkData }) {
  ...
  return (
    <button
      ...
      className="group flex items-center gap-2 rounded-lg border-2 border-transparent px-3 py-3 transition-colors duration-300 hover:border-custom-emerald hover:bg-custom-gray-300 hover:text-custom-emerald md:h-[50px] md:w-[160px] lg:h-[70px] lg:w-[160px] xl:h-[85px] xl:w-[180px] 2xl:h-[105px] 2xl:w-[250px]"
    >
      <img
