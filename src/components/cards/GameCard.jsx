...
function GameCard({ gameData }) {
  ...
  return (
    <div className="rounded-lg border-2 border-transparent font-medium transition-transform ease-in-out hover:-translate-y-1 hover:scale-105 hover:cursor-pointer hover:border-custom-emerald md:w-[132px] lg:w-[152px] xl:w-[172px] 2xl:w-[212px]">
